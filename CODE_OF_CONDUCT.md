...
age, body size, disability, ethnic origin, sex characteristics, gender
...
repository, issues, pull requests, discussions, and any other channels
the project uses — and also applies when an individual is representing
the project in public spaces (e.g. posting under the official project
account, or acting as a representative at an event).

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behaviour may
be reported to the project maintainers at
**msoltanov@users.noreply.github.com** or via a
[private GitHub security advisory](https://github.com/msoltanov/astro-paper-plus/security/advisories/new).
All complaints will be reviewed and investigated promptly and fairly.

The project team is obligated to respect the privacy and security of
...
**Community impact**: A single incident or series of actions in
...
**Consequence**: A temporary ban from any sort of public interaction
with the community for a specified period of time. No public or
private interaction with the people involved is allowed during this
period.
