...
title: AstroPaper+ 5.0 (upstream release — inherited by AstroPaper+)
slug: astro-paper-v5
featured: false
ogImage: assets/AstroPaper+-v5.png
tags:
  - release
description: "AstroPaper+ v5: keep the clean look, updates under the hood. (Upstream release preserved in AstroPaper+ fork history.)"
---
...
![AstroPaper v5](assets/AstroPaper+-v5.png)
