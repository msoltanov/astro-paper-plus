...
title: AstroPaper+ 6.0 (upstream release — inherited by AstroPaper+)
slug: astro-paper-v6
featured: true
ogImage: assets/AstroPaper+-v6.png
tags:
  - release
description: "AstroPaper+ v6: a from-scratch rewrite on Astro v6, Tailwind v4, and a new config system. (Upstream release preserved in AstroPaper+ fork history.)"
---
...
- `_components/` scoping: post-specific components live under `src/components/post/` and do not pollute the broader `src/components/` directory.
