...
AstroPaper+ ships with a collection of predefined color schemes (inherited from upstream AstroPaper+) that can be applied to customize the theme appearance. Each scheme defines a complete set of CSS custom properties (variables) for light and dark modes.

## Table of contents

## Quick Start

To apply a predefined color scheme, copy the CSS variable definitions into your theme configuration. For detailed setup instructions, see the color scheme configuration guide.
