...
tags:
  - color-schemes
  - docs
description: How you can enable/disable light & dark mode; and customize color schemes of the AstroPaper+ theme.
---
import ResponsiveTable from '@/components/ResponsiveTable.astro';

This guide covers how to enable or disable light and dark mode, and how to customize the color scheme for the entire site. (AstroPaper+ is a fork of AstroPaper by [Sat Naing](https://github.com/satnaing).)
...
> Check out some predefined color schemes AstroPaper+ (the original theme) has already crafted for you — they all work as-is in the AstroPaper+ fork.
