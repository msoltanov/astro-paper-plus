...
This document demonstrates how to use LaTeX equations in your Markdown files for AstroPaper+ (a fork of AstroPaper by Sat Naing). LaTeX is a powerful typesetting system often used for mathematical and scientific documents.
...
> **Originally written by [Alberto Perdomo](https://github.com/aperdomom) on the upstream AstroPaper project. Translated and adapted for the AstroPaper+ fork by [Mekan Soltanov](https://github.com/msoltanov).**
